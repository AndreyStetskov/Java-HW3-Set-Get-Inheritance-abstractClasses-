public abstract class Person {
    ...
    public void setHeight(int height) {
        if (height >= 45) {
            ...
            System.err.print("Error. Height was entered negative. ");
            System.out.println("Please, enter some positive number for height");
        } else if (height >= 0 && height < 45) {
        System.err.print("Error. Perhaps height was entered incorrectly. ");
        System.out.println("Height is so small. The normal height cannot be less than 45 cm. Are you sure that the height is " + height + "cm?");
            ...
            System.err.print("Error. Height was entered incorrectly. ");
            System.out.println("Please, enter some positive number for height");
        }
    }
    ...
    public void setWeight(int weight) {
        if (weight >= 2) {
            ...
            System.err.print("Error. Weight was entered negative. ");
            ...
            System.err.print("Error. Weight was entered incorrectly. ");
            System.out.println("Please, enter some positive number for weight");
        }
    }
